...
uint32_t DrvPWM_SetTimerClk(uint8_t u8Timer, S_DRVPWM_TIME_DATA_T *sPt)
{
	...
	{	
		...
		u32duty = sPt->u32Duty * sPt->u8HighPulseRatio / sPt->u8HighPulseBase - 1;
	...
	else
	{
		...
		if (u8Timer & 0x10)
		{
			...
			u16cmrData = sPt->u32Duty * sPt->u8HighPulseRatio / sPt->u8HighPulseBase - 1;		
		}
		else
		{
		 	u16cnrData = u16Duty - 1;
			u16cmrData = u16Duty * sPt->u8HighPulseRatio / sPt->u8HighPulseBase - 1;
		}
