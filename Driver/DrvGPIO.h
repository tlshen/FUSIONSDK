...
#define GPF_6	            _DRVGPIO_DOUT(5, 6)
#define GPF_7	            _DRVGPIO_DOUT(5, 7)
#define GPF_8	            _DRVGPIO_DOUT(5, 8)
#define GPF_9	            _DRVGPIO_DOUT(5, 9)
#define GPF_10	            _DRVGPIO_DOUT(5, 10)
#define GPF_11	            _DRVGPIO_DOUT(5, 11)
#define GPF_12	            _DRVGPIO_DOUT(5, 12)
#define GPF_13	            _DRVGPIO_DOUT(5, 13)
#define GPF_14	            _DRVGPIO_DOUT(5, 14)
#define GPF_15	            _DRVGPIO_DOUT(5, 15)
typedef enum 
{
	E_GPA = 0,
	E_GPB = 1, 
...
typedef enum
{
    ...
    E_FUNC_TMR2,    E_FUNC_TMR3,    E_FUNC_UART0,   E_FUNC_UART1,   E_FUNC_UART2,   
	...
	E_FUNC_EBI_8B,  E_FUNC_EBI_16B, E_FUNC_SPI0_QFN36PIN ,
	E_FUNC_PS2    
} E_DRVGPIO_FUNC;
